...
export const CommunicationAudience = () => {
    return (
        <div className="bg-white border border-slate-100 rounded-xl shadow-sm p-4 flex flex-col justify-between flex-1">
            ...
            <div className="flex flex-col gap-2.5 mb-3">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2 min-w-0">
                        ...
                        <span className="text-[11px] font-semibold text-slate-700 truncate">แผนกครัว (Kitchen)</span>
                    </div>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2 min-w-0">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0"></div>
                        <span className="text-[11px] font-semibold text-slate-700 truncate">แม่บ้าน (Housekeeping)</span>
                    </div>
                    <div className="flex items-center gap-4">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2 min-w-0">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0"></div>
                        <span className="text-[11px] font-semibold text-slate-700 truncate">ผู้จัดการแผนก (Department Manager)</span>
                    </div>
                    <div className="flex items-center gap-4">
