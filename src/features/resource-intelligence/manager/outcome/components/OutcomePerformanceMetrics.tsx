...
export const OutcomePerformanceMetrics = () => {
    return (
        <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.04)] p-0 h-full flex flex-col justify-between overflow-hidden">
            <div className="p-4 pb-0 min-h-0">
                <h3 className="text-[14px] font-bold text-indigo-900 tracking-tight mb-3">ประสิทธิภาพการดำเนินงาน</h3>

                <div className="flex text-[9px] font-bold text-slate-400 mb-2.5 border-b border-slate-50 pb-2">
                    ...
                    {metrics.map((item, index) => (
                        <div key={index} className="flex items-center text-[11px]">
                            ...
                            <div className="w-[30%] flex items-center gap-2">
                                <span className="font-bold text-slate-800 whitespace-nowrap">{item.value}</span>
                                <div className="flex-1 max-w-[50px] h-1.5 bg-slate-100 rounded-full overflow-hidden shrink-0">
                                    <div
            ...
            <div className="w-full border-t border-slate-100 py-2.5 flex justify-center">
