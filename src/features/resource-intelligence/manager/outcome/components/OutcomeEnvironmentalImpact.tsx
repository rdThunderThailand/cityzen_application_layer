...
export const OutcomeEnvironmentalImpact = () => {
    return (
        <div className="bg-white border border-slate-100 rounded-xl shadow-sm p-4 h-full flex flex-col justify-between">
            ...
            <h3 className="text-[13px] font-bold text-slate-800">ผลลัพธ์ด้านสิ่งแวดล้อม</h3>

            <div className="grid grid-cols-4 ">

                    {/* Carbon Saving */}
                    <div className="flex flex-col items-center text-center">
                        <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center mb-1">
                            <TreePine className="w-4 h-4 text-emerald-600" />
                        </div>
                        <span className="text-[9px] font-medium text-slate-500 leading-tight">Carbon Saving</span>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-[9px] font-medium text-slate-500 leading-tight">เทียบเท่าการปลูกต้นไม้</span>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-[9px] font-medium text-slate-500 leading-tight ">น้ำที่ประหยัดได้</span>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-[9px] font-medium text-slate-500 leading-tight ">พลังงานที่ประหยัดได้</span>
