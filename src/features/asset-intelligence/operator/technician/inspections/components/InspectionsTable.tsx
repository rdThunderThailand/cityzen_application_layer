...
export function InspectionsTable({ inspections, selectedId, onSelect }: InspectionsTableProps) {
  return (
    <div className="overflow-x-auto">
      <TechnicianTable
        minWidth="1300px"
        emptyMessage="ไม่พบข้อมูลการตรวจสอบหน้างาน"
        columns={[
          { header: <input type="checkbox" className="rounded border-slate-300 text-blue-600 focus:ring-blue-500" />, align: "center", width: "50px" },
          { header: "เลขที่ใบงาน" },
