    ...
    <div className="p-4 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white">
      <div className="flex flex-col lg:flex-row lg:items-center gap-4 w-full">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          {(filters.length > 0 || extraActions) && (
            <button className="mt-5 px-4 py-2 rounded-lg border border-blue-200 bg-white text-blue-600 font-bold text-[13px] flex items-center gap-2 hover:bg-blue-50 transition-colors h-[38px]">
      ...
      {onClearFilters && (
        <button
          ...
          className="mt-5 px-4 py-2 text-[12px] font-bold text-slate-500 hover:text-slate-800 flex items-center gap-1.5 transition-colors whitespace-nowrap shrink-0 h-[38px]"
        >
