...
export const wasteData: Array<{
    ...
    subValue: string | number | null; subUnit: string | null; positiveData?: boolean; subtitle:string;
}> = [
    ...
    { title: "Pickup (วันนี้)", value: "14:00", unit: "รอบเดียว", icon: Truck, subValue: null, subUnit:" ", subtitle: "Green Waste Co., Ltd."},
];  